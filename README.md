...
volumes:
  app-volume:
```
Либо можно использовать команду  ```docker run -p 8000:8000 -v ${PWD}/.env:/app/.env docker.tolq3.ru/contractor:main-latest gunicorn contractor.wsgi:application --bind 0.0.0.0:8000```
