...
urlpatterns = [
	...
	path('add_member/<uuid>/v1/', project_add_member_v1.as_view()),
	path('remove_member/<uuid>/v1/', project_remove_member_v1.as_view()),
	path('member_permission/<uuid>/v1/', project_change_member_permission_v1.as_view()),
	path('change_owner/<uuid>/v1/', project_change_owner_v1.as_view()),
	path('change_company/<uuid>/v1/', project_change_company_v1.as_view()),
	path('update_info/<uuid>/v1/', project_update_info_v1.as_view()),
